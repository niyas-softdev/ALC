    ...
    <div className="bg-white py-16">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mt-12 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
          <div className="text-center">
            <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-r from-[#d4af37] to-[#f4e2d8] text-white">
              <svg
              ...
              >
                <path
                  ...
                  strokeWidth={2}
                  d="M12 8c1.657 0 3 1.343 3 3m0 0a3 3 0 11-6 0m3 3v5m-4-4h8"
                />
              </svg>
            </div>
            ...
            <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-r from-[#d4af37] to-[#f4e2d8] text-white">
              ...
              >
                <path
                  ...
                  strokeLinejoin="round"
                  strokeWidth={2}
                  d="M3 10h3m6 0h3m-9 4h3m6 0h3M4 6h16M4 18h16"
                />
              </svg>
            </div>
        ...
        <div className="mt-12 text-center">
          <a
            href="#"
            className="inline-block rounded-md bg-gradient-to-r from-[#d4af37] to-[#f4e2d8] px-6 py-3 text-sm font-bold text-white shadow-lg hover:from-[#c29d2e] hover:to-[#e2c4a6]"
          >
            Learn More About Us
          </a>
        </div>
